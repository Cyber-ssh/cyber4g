...
echo ""
echo -e "                 \033[1;31mBy @cybercoari\033[1;36m"
echo ""
...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/Cyber-ssh/checkUser-4G/main/chuser > /dev/null 2>&1
wget https://raw.githubusercontent.com/Cyber-ssh/checkUser-4G/main/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/Cyber-ssh/checkUser-4G/main/checkuser.py > /dev/null 2>&1
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@cybercoari\033[0m"
